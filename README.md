# Caso Práctico 2 - DevOps en Azure
...
http://IP_VM:8080 5. Configuración de AKS
az aks get-credentials --resource-group rg-casopractico2 --name aks-casopractico2 --overwrite-existing
kubectl get nodes 6. Despliegue en AKS
cd ../k8s
kubectl apply -f . 7. Verificación de la app en AKS
